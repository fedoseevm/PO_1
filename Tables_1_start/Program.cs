    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // Napisz program, który pobiera od użytkownika 10 liczb całkowitych i zapisuje je w tablicy. Następnie program wyświetla sumę wszystkich elementów tablicy.
            ...
            {
                Console.Write($"Podaj {i + 1} element tablicy (liczba calkowita): ");
                //while (!int.TryParse(Console.ReadLine(), out table_ex2[i]))
                //{
                //    Console.WriteLine("\nNiepoprawna wartosc. Wprowadz liczbe calkowita.\n");
                //    Console.Write($"Podaj {i + 1} element tablicy (liczba calkowita): ");
                //}
                //sum2 += table_ex2[i];
